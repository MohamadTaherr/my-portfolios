...
export default function Scriptwriting() {
  ...
  return (
    <section id="scriptwriting" className="relative py-24 md:py-32 bg-muted/30">
      ...
      <div 
        className="absolute top-40 -left-20 w-96 h-96 bg-secondary/5 rounded-full blur-3xl pointer-events-none" 
        style={{ 
      ...
      />
      <div 
        className="absolute bottom-40 -right-20 w-96 h-96 bg-primary/5 rounded-full blur-3xl pointer-events-none" 
        style={{ 
          contain: 'layout style paint',
          willChange: 'auto',
          transform: 'translateZ(0)'
